...
- `task_6_books_stdout.txt`, `task_6_ice_cream_stdout.txt`, and `task_6_study_breaks_stdout.txt` each contain conversations I had the models along with chat histories demonstrating the changes to roles and system prompts implemented for this task.
